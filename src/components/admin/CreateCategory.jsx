...
const CreateCategory = () => {
  ...
  const handleImageChange = async (e) => {
    ...
    try {
      ...
      setImgUploading(false);
      if(error.message=="imgRef is not defined" || error.message=="error Cannot set properties of undefined (setting 'src')"){
      ...
      {loading ? (
        ...
        <div className="container-xl mt-2">
          <h4 className="fw-bold py-3 mb-4">
            <span className="text-muted fw-light">Category/</span> {id?"Update":"Create"}
          </h4>
          {/*
            image start
          */}
            ...
            <div className="col-xxl">
              <div className="card mb-4">
                <div className="card-header d-flex align-items-center justify-content-between">
                  <h5 className="mb-0">{id?"Update Category":"Create Category"}</h5>
                </div>
